...
def initialize_state():
    ...
    with state_lock:
        ...
        # Initial baseline trains along Mumbai Central Line corridor
        state.trains = [
            {
                "id": "T101",
                "name": "T101 Express",
...
def get_network():
    ...
    with state_lock:
        nodes_data = []
        coords_map = {
            "CSMT": {"lat": 18.9400, "lon": 72.8353, "x": 60, "y": 220},
            "BY": {"lat": 18.9750, "lon": 72.8333, "x": 220, "y": 220},
            "DR": {"lat": 19.0180, "lon": 72.8430, "x": 400, "y": 220},
            "CLA": {"lat": 19.0650, "lon": 72.8790, "x": 580, "y": 220},
            "GC": {"lat": 19.0860, "lon": 72.9080, "x": 740, "y": 220},
            "TNA": {"lat": 19.1860, "lon": 72.9750, "x": 900, "y": 220},
        }
