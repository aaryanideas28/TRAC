...
def initialize_state():
    ...
    with state_lock:
        ...
        # Initial baseline trains along Mumbai Central Line corridor (Real Fetched Trains from selected_trains.json / live_observations_master.csv)
        ...
        state.trains = [
            ...
            {
                "id": "T201",
                "name": "97421 / Mumbai CSMT - Thane Slow Local",
                "type": "Slow Local",
                "origin": "CSMT",
                "origin_name": "CHHATRAPATI SHIVAJI MAHARAJ TERMINUS",
                "destination": "TNA",
        ...
        state.recommendations = [
            ...
            },
            {
                ...
                "action": "Maintain Down Slow Track Schedule",
                "action_type": "PROCEED",
                "assigned_track": "Track 1 (Down Slow)",
                "waiting_time_sec": 0,
                "expected_delay_reduction_min": 2.1,
                "reason": "Optimal headway interval behind express service maintained.",
                "solver_status": "FEASIBLE",
...
def get_network():
    ...
    with state_lock:
        nodes_data = []
        coords_map = {
            "CSMT": {"lat": 18.9400, "lon": 72.8353, "x": 40, "y": 220},
            "MSD": {"lat": 18.9510, "lon": 72.8380, "x": 90, "y": 220},
            "SNRD": {"lat": 18.9610, "lon": 72.8390, "x": 140, "y": 220},
            "BY": {"lat": 18.9750, "lon": 72.8333, "x": 190, "y": 220},
            "CHG": {"lat": 18.9870, "lon": 72.8340, "x": 240, "y": 220},
            "CRD": {"lat": 18.9970, "lon": 72.8360, "x": 290, "y": 220},
            "PR": {"lat": 19.0090, "lon": 72.8390, "x": 340, "y": 220},
            "DR": {"lat": 19.0180, "lon": 72.8430, "x": 390, "y": 220},
            "MTN": {"lat": 19.0280, "lon": 72.8520, "x": 440, "y": 220},
            "SION": {"lat": 19.0430, "lon": 72.8630, "x": 490, "y": 220},
            "CLA": {"lat": 19.0650, "lon": 72.8790, "x": 540, "y": 220},
            "VVH": {"lat": 19.0770, "lon": 72.8950, "x": 590, "y": 220},
            "GC": {"lat": 19.0860, "lon": 72.9080, "x": 640, "y": 220},
            "VK": {"lat": 19.1060, "lon": 72.9260, "x": 690, "y": 220},
            "KJRD": {"lat": 19.1240, "lon": 72.9370, "x": 740, "y": 220},
            "BND": {"lat": 19.1410, "lon": 72.9460, "x": 790, "y": 220},
            "NHU": {"lat": 19.1550, "lon": 72.9540, "x": 840, "y": 220},
            "MLND": {"lat": 19.1720, "lon": 72.9620, "x": 890, "y": 220},
            "TNA": {"lat": 19.1860, "lon": 72.9750, "x": 940, "y": 220},
        }

        for code, node in state.graph._nodes.items():
            node_dict = node.to_dict()
            coord = coords_map.get(code, {"x": 500, "y": 220, "lat": 19.0, "lon": 72.8})
            node_dict.update({
                "pos_x": coord["x"],
                "pos_y": coord["y"],
                "lat": coord["lat"],
            ...
            state.recommendations = [
                {
                    ...
                    "affected_train_id": "T104",
                    "affected_train_name": "T104 Superfast",
                    "action": "Reroute via Down Slow Track & Signal S-14 Crossover",
                    "action_type": "TRACK_CHANGE",
                    "assigned_track": "Track 1 (Down Slow)",
                    "waiting_time_sec": 45,
                    "expected_delay_reduction_min": 5.4,
                    "reason": "OR-Tools CP-SAT solver bypassed Dadar blockage by allocating Down Slow Track resource with zero headway violation.",
                    "solver_status": solver_status,
                    "ml_congestion_prob": state.ml_prediction.get("congestion_prob", 0.08),
                },
                {
                    "id": "REC-OPT-102",
                    "affected_train_id": "T201",
                    "affected_train_name": "T201 Fast Local",
                    "action": "Hold T201 for 60s at Byculla Crossover",
                    "action_type": "HOLD",
                    "assigned_track": "Track 1 (Down Slow)",
                    "waiting_time_sec": 60,
                    "expected_delay_reduction_min": 3.8,
                    "reason": "Hold constraint ensures priority T104 Express clears Dadar section before T201 insertion.",
                    "solver_status": solver_status,
                    "ml_congestion_prob": state.ml_prediction.get("congestion_prob", 0.08),
                },
            ]
