...
let mockTrains: Train[] = [
  ...
  // --- LOOP LINES & SIDINGS TRAINS (Trapped / Overtake Berthing) ---
  {
    id: '97259',
...
let mockMetrics: KpiMetrics = {
  ...
  track_utilization_pct: 86,
  utilization_trend_pct: 12.0,
